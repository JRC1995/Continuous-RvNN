...
train_save_path = Path('processed_data/PNLI_A_train.jsonl')
dev_save_path = {}
for key in dev_keys:
    dev_save_path[key] = Path('processed_data/PNLI_A_dev_{}.jsonl'.format(key))
test_save_path = {}
for key in test_keys:
    test_save_path[key] = Path('processed_data/PNLI_A_test_{}.jsonl'.format(key))
metadata_save_path = fspath(Path("processed_data/PNLI_A_metadata.pkl"))
